...
/**
 * This core plugin doesn't actually do anything apart from log a message.
 */
@IFMLLoadingPlugin.MCVersion("1.10.2")
@IFMLLoadingPlugin.SortingIndex(1001)
public class ForgeDeobfuscationTestModCorePlugin implements IFMLLoadingPlugin {
	public ForgeDeobfuscationTestModCorePlugin() {
		LogManager.getLogger("ForgeDeobfuscationTestMod").info("Core Plugin loaded!");
	}
